...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><?= __('Human Resource Dashboard')?></h1>
...
<div class="row">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <?= __('Total Type of Permision')?>
            <?php
            $connection = mysqli_connect("localhost","root","","wptc_attendance");

            $dash_permisiontype_query = "SELECT * FROM permisiontype";
            $dash_permisiontype_query_run = mysqli_query($connection, $dash_permisiontype_query);

            if ($permisiontype_total = mysqli_num_rows($dash_permisiontype_query_run)) {
    ...
    '</div>';
        ...
        echo '<div class="h5 mb-0 font-weight-bold text-gray-800"> NO Employee in Database </div>';
    }
    ?>
                    </div>
                    <div class="col-auto">
    ...
    '</div>';
        ...
        $x = __('NO Department in Database');
