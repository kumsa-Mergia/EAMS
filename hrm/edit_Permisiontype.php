...
<div class="container-fluid">
 ...
 <div class="card shadow mb-4">
    <div class="card header py-3">
      <h6 class="m-4 font-weight-bold text-primary"> <?= __('Edit Permision Type')?>
...
if (isset($_POST['edit_btn'])) {
       ...
       $query = "SELECT * FROM permisiontype WHERE id='$id' ";
...
<input type="hidden" name="edit_id" value="<?php echo $row['id'] ?>">
 <div class="form-group">
    ...
    <input type="text" name="edit_permisiontype" value="<?php echo $row['permisiontype']; ?>" class="form-control" placeholder="Enter Name" required>
</div>
<a href="Permisiontype.php" class="btn btn-danger"><?= __('Cancel')?></a>
<button type="submit" name="updatepermisiontype" class="btn btn-primary"><?= __('update')?></button>
 </form>
