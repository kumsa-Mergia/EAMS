...
<div class="form-group">
    ...
    <input type="text" name="departmentname" class="form-control" placeholder="Enter Name" required>
</div>
...
<button type="submit" name="departmentrbtn" class="btn btn-primary"><?= __('Save changes')?></button>
             </div>
      </form>
